...
public class PasswordHash {
     ...
     */
    public static boolean validatePassword(final String password, final String goodHash)
     ...
     * @return true if the password is correct, false if not
     */
    public static boolean validatePassword(final char[] password, final String goodHash)
            throws NoSuchAlgorithmException, InvalidKeySpecException {
